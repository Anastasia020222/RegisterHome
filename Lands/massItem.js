const massItemBlog = [
    {blog_en: 'https://blog.olymptrade.com/?lang=en'},
    {blog_es: 'https://blog.olymptrade.com/es/'},
...
const massItemFacebook = [
    {facebook_en: 'https://www.facebook.com/olymptradecom/'},
    {facebook_in: 'https://www.facebook.com/groups/OlympTradeIndiaOfficialGroup/'},
    {facebook_id: 'https://www.facebook.com/groups/olymptradeindonesiaofficialgroup/'}
];

const massItemInstagram = [
    {instagram_en: 'https://www.instagram.com/olymptradecom/'}
]


module.exports = {massItemBlog, massItemTwitter, massItemYoutube, massItemFacebook, massItemInstagram}
